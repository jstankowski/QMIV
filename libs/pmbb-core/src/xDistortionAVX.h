...
public:
  ...
  static inline tSDSSD CalcSSS(const uint16* Tst, const uint16* Ref, int32 TstStride, int32 RefStride, int32 Width, int32 Height, int32 BitDepth) { return BitDepth <= 14 ? CalcSSS14(Tst, Ref, TstStride, RefStride, Width, Height) : xDistortionSTD::CalcSSS(Tst, Ref, TstStride, RefStride, Width, Height, BitDepth); }
};
